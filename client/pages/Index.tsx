...
const categories = [
  {
    ...
    name: "Geography",
    description:
      "Test your knowledge about capitals, countries, maps, rivers, and mountains.",
    icon: Globe,
  ...
  },
  {
    ...
    name: "History",
    description:
      "Explore historical events, famous figures, civilizations, and discoveries.",
    icon: BookOpen,
  ...
  },
  {
    ...
    description:
      "Fun facts, inventions, and diverse trivia from across the world.",
    icon: Lightbulb,
...
export default function Index() {
  return (
    <div
      className="min-h-screen bg-luxurious-gradient"
      style={{ backgroundColor: "hsl(39, 100%, 96%)" }}
    >
      {/* Header */}
      <header
        className="sticky top-0 z-50 backdrop-blur-md border-b-2 border-primary/30"
      ...
      <section className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
        <div className="text-center mb-16">
          <h2 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-foreground mb-6 leading-tight">
            Elevate Your{" "}
            <span className="text-primary font-black">Knowledge</span>
          </h2>
          <p className="text-lg sm:text-xl text-foreground/80 max-w-3xl mx-auto mb-8 font-medium">
            Discover a world of learning with our premium quiz experience. Over
            1,200 carefully crafted questions across 6 fascinating categories,
            designed to challenge and inspire you daily.
          </p>
        </div>
            ...
            return (
              <Link key={category.id} to={`/quiz/${category.id}`}>
                <Card className="group h-full overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 cursor-pointer bg-white">
                  {/* Icon Background */}
                  <div
                    className={`h-32 ${category.iconBg} flex items-center justify-center relative overflow-hidden`}
                  >
                    ...
                    <div
                      className={`${category.iconColor} transform group-hover:scale-125 transition-transform duration-300`}
                    >
      ...
      {/* Footer */}
      <footer
        className="border-t-2 border-primary/30 mt-20 py-12 backdrop-blur"
        style={{ backgroundColor: "hsl(39, 100%, 94%)" }}
      >
